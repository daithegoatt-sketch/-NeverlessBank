...
function newUser() {
  return {
    ...
    inventory: {},
    businesses: [],
    store: { name: '', slots: 3, listings: [], revenue: 0, expenses: 0, sales: 0 },
    salaryAt: 0,
    tipAt: 0,
    loanAt: 0,
    earned: 0,
...
function packUser(s) {
  return {
    ...
    iv: s.inventory || {},
    bz: Array.isArray(s.businesses) ? s.businesses.slice(0, 12) : [],
    sr: s.store || { name:'', slots:3, listings:[], revenue:0, expenses:0, sales:0 },
    sa: s.salaryAt,
    ta: s.tipAt,
    la: s.loanAt || 0,
    e: s.earned,
...
function unpackUser(x = {}) {
  ...
  return {
    ...
    inventory: x.iv && typeof x.iv === 'object' && !Array.isArray(x.iv) ? x.iv : {},
    businesses: Array.isArray(x.bz) ? x.bz.slice(0,12) : [],
    store: x.sr && typeof x.sr === 'object' && !Array.isArray(x.sr) ? x.sr : { name:'', slots:3, listings:[], revenue:0, expenses:0, sales:0 },
